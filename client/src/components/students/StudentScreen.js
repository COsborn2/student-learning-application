...
const StudentHome = () => (
  <div className='container text-center'>
    <header className='jumbotron my-3 bg-info'>
      <h1 className='display-4 font-weight-bold'>Students</h1>
    </header>

    <div className='row'>
      <div className='col-md-6'>
        <Button bsStyle='info' className='mx-auto mb-4 auto card badge-success' onClick={() => this.props.history.push('/student/spelling')}>
      ...
      <div className='col-md-6'>
        <Button bsStyle='info' className='mx-auto mb-4 card badge-success' onClick={() => this.props.history.push('/student/writing')}>
...
class StudentScreen extends Component {
  ...
  render () {
    ...
    if (!isAuthenticated) { return <StudentLogin onAuthenticate={() => this.setState({ isAuthenticated: true })} /> }
