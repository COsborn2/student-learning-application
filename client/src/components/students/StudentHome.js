  ...
  <div className='container text-center'>
    ...
    <div className='row'>
      <div className='col-md-6'>
        <Button bsStyle='info' className='mx-auto mb-4 auto card badge-success' onClick={() => props.history.push('/student/spelling')}>
      ...
      <div className='col-md-6'>
        <Button bsStyle='info' className='mx-auto mb-4 card badge-success' onClick={() => props.history.push('/student/writing')}>
