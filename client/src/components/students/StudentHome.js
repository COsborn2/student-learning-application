...
const StudentHome = (props) => (
  <div className='container text-center'>
    <header className='jumbotron my-3 bg-info'>
      <h1 className='display-4 font-weight-bold'>Students {props.match.params.id}</h1>
    </header>

    <div className='row'>
      <div className='col-md-6'>
        <Button bsStyle='info' className='mx-auto mb-4 auto card badge-success' onClick={() => props.history.push(props.match.url + '/spelling')}>
      ...
      <div className='col-md-6'>
        <Button bsStyle='info' className='mx-auto mb-4 card badge-success' onClick={() => props.history.push(props.match.url + '/writing')}>
