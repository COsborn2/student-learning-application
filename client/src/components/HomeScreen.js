      ...
      <div className='container text-center'>
        ...
        <div className='row'>
          <div className='col-md-6'>
            <Button bsStyle='info' className='mx-auto mb-4 card badge-success' onClick={() => this.props.history.push('/instructor')}>
          ...
          <div className='col-md-6'>
            <Button bsStyle='info' className='mx-auto mb-4 card badge-success' onClick={() => this.props.history.push('/student')}>
