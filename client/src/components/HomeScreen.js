      ...
      <div className='container text-center'>
        ...
        <div className='row'>
          <div className='col-md-6'>
            <Button bsStyle='info' className='mx-auto card badge-success' onClick={() => this.props.history.push('/spelling')}>
          ...
          <div className='col-md-6'>
            <Button bsStyle='info' className='mx-auto card badge-success' onClick={() => this.props.history.push('/writing')}>
