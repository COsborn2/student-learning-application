      ...
      <React.Fragment>
        <div className='container'>
          ...
          <div className='row'>
            <Card
              title='Spelling'
              imageSrc={spellingImgSrc}
              description='A simple demo using drag and drop to spell the word using the letter blocks provided'
              onClick={() => alert('spell')}
            />
            <Card
              title='Hand Writing'
              imageSrc={writingImgSrc}
              description='Hand write to spell the words'
              onClick={() => alert('write')}
            />
          </div>
        </div>
